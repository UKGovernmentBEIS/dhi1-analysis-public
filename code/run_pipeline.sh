...
# Writes to ../parameter_estimates/ and ../plots/ by default.
#
# Usage: bash run_pipeline.sh [extra args forwarded to the pipeline]
#   e.g. bash run_pipeline.sh --output-dir ../my_estimates --plots-dir ../my_plots
set -e
