#!/usr/bin/env python3
"""
Full GLM pipeline for main outcome analyses, retaining the subject-level compliance
score (sub_compliance) as a covariate.

This variant is NOT canonical. sub_compliance is measured post-treatment, so including
...
# tmux new -s pipeline
# cd code/
# python data_analysis_pipeline.py --dataset trust --prompting 0 2>&1 | tee pipeline_output.log
